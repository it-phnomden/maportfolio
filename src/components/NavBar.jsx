...
const NavBar = () => {
  ...
  return (
    <div
      className={`shadow-sm shadow-slate-100 w-screen dark:shadow-slate-900 h-[60px] px-3 flex justify-between items-center fixed dark:bg-opacity-80 bg-opacity-80 backdrop-blur-sm`}
    >
